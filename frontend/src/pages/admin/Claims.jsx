      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div className="space-y-2">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900 dark:text-white bg-clip-text text-transparent bg-gradient-to-r from-gray-900 to-purple-600 dark:from-white dark:to-purple-400">
                  Claims Management
                </h1>
        ...
        <div className="rounded-3xl p-8 border border-gray-200 dark:border-white/20 bg-white/80 dark:bg-white/10 backdrop-blur-xl shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <select
                  ...
                  className="input-field rounded-2xl border-gray-200 dark:border-white/20 bg-white/50 dark:bg-white/5 text-gray-900 dark:text-white focus:border-purple-500 focus:ring-purple-500 transition-all duration-200"
                >
                  <option value="">Choose a claim...</option>
                  {claims.map((claim) => (
                    <option key={claim._id} value={claim._id} className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
              ...
              <div>
                ...
                >
                  ...
                  {agents.map((agent) => (
                    <option key={agent._id} value={agent._id} className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
            ...
            {}
            {activeClaim && (
              <div className="p-6 bg-gradient-to-r from-gray-50 to-purple-50 dark:from-white/5 dark:to-purple-500/5 rounded-2xl border border-gray-200 dark:border-white/10 backdrop-blur-md">
                <div className="flex items-center space-x-3 mb-4">
                  <Shield className="w-5 h-5 text-purple-600 dark:text-purple-400" />
                  <h3 className="text-lg font-semibold text-purple-700 dark:text-purple-200">Selected Claim Details</h3>
                </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-2 border border-gray-200 dark:border-white/20 rounded-2xl bg-white/50 dark:bg-white/5 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 placeholder-gray-400"
                />
              </div>
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="pl-10 pr-8 py-2 border border-gray-200 dark:border-white/20 rounded-2xl bg-white/50 dark:bg-white/5 text-gray-900 dark:text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all duration-200 appearance-none"
                >
                  ...
                  <option value="in_review" className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white">In Review</option>
                  <option value="approved" className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white">Approved</option>
                  <option value="rejected" className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white">Rejected</option>
                  <option value="settled" className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white">Settled</option>
                </select>
              </div>
            </div>
          </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-white/10">
                    <th className="text-left py-4 px-6 text-sm font-semibold text-gray-900 dark:text-white">Claim Details</th>
                    <th className="text-left py-4 px-6 text-sm font-semibold text-gray-900 dark:text-white">Driver</th>
                    <th className="text-left py-4 px-6 text-sm font-semibold text-gray-900 dark:text-white">Severity</th>
                    <th className="text-left py-4 px-6 text-sm font-semibold text-gray-900 dark:text-white">Status</th>
                    <th className="text-left py-4 px-6 text-sm font-semibold text-gray-900 dark:text-white">Agent</th>
                    <th className="text-left py-4 px-6 text-sm font-semibold text-gray-900 dark:text-white">Report</th>
                    <th className="text-left py-4 px-6 text-sm font-semibold text-gray-900 dark:text-white">Created</th>
                    <th className="text-left py-4 px-6 text-sm font-semibold text-gray-900 dark:text-white">Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {filteredClaims.map((claim) => (
                    <tr 
                      key={claim._id} 
                      className="border-b border-gray-100 dark:border-white/5 hover:bg-black/5 dark:hover:bg-white/5 transition-colors duration-200"
                    >
                      ...
                      <td className="py-4 px-6">
                        {claim.reportId?.reportUrl ? (
                          <a
                            ...
                            className="inline-flex items-center space-x-2 text-blue-600 dark:text-blue-400 hover:text-blue-500 dark:hover:text-blue-300 text-sm font-medium transition-colors duration-200"
                          >
                      ...
                      <td className="py-4 px-6">
                        <button
                          ...
                          className="inline-flex items-center space-x-2 text-purple-600 dark:text-purple-400 hover:text-purple-500 dark:hover:text-purple-300 text-sm font-medium transition-colors duration-200 bg-purple-500/10 px-3 py-2 rounded-xl hover:bg-purple-500/20"
                        >
