      ...
      >
        <div className="flex items-center space-x-3">
          <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
            ...
            <Icon className={`w-5 h-5 ${selected ? 'text-indigo-400' : role.color}`} />
          </div>
  ...
  return (
    <div className="min-h-screen bg-transparent py-8 px-4">
      <div className="max-w-4xl mx-auto space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <input
                ...
                className="input-field rounded-2xl px-4 py-3 text-lg border border-white/20 bg-white/5 text-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all duration-300 placeholder-gray-400"
                ...
                {priorities.map((priority) => (
                  ...
                  >
                    <span className={`text-sm font-medium ${
                      formData.priority === priority.value ? priority.color : 'text-gray-400'
                    }`}>
                      {priority.label}
                    </span>
                  </button>
            ...
            <div>
              ...
              <textarea
                ...
                className="input-field rounded-2xl px-4 py-4 border border-white/20 bg-white/5 text-white focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all duration-300 resize-none placeholder-gray-400"
                rows={12}
        ...
        {}
        <div className="rounded-3xl p-6 border border-blue-500/20 bg-blue-500/5 backdrop-blur-sm">
          <div className="flex items-start space-x-3">
            <div className="w-6 h-6 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
              <Bell className="w-3 h-3 text-white" />
            </div>
            <div>
              <h3 className="font-semibold text-blue-200 mb-1">Broadcast Best Practices</h3>
