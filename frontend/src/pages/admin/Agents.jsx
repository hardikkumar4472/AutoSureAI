      ...
      <div className="max-w-7xl mx-auto space-y-8">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200 dark:border-white/10">
                    <th className="text-left py-4 px-6 text-sm font-semibold text-gray-900 dark:text-white">Agent Details</th>
                    <th className="text-left py-4 px-6 text-sm font-semibold text-gray-900 dark:text-white">Contact</th>
                    <th className="text-left py-4 px-6 text-sm font-semibold text-gray-900 dark:text-white">Workload</th>
                ...
                <tbody>
                  {agents.map((agent) => (
                    <tr key={agent._id} className="border-b border-gray-100 dark:border-white/5 hover:bg-black/5 dark:hover:bg-white/5 transition-colors duration-200">
                      ...
                      <td className="py-4 px-6">
                        <div className="flex space-x-2">
                          <button
                            ...
                            className="p-2 text-blue-600 dark:text-blue-400 hover:bg-blue-500/10 rounded-xl transition-all duration-200 hover:shadow-lg"
                            title="Edit Agent"
                          >
                          ...
                          <button
                            ...
                            className="p-2 text-red-600 dark:text-red-400 hover:bg-red-500/10 rounded-xl transition-all duration-200 hover:shadow-lg"
                            title="Delete Agent"
                          >
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-white dark:bg-gray-900 rounded-3xl max-w-md w-full p-8 shadow-2xl border border-gray-200 dark:border-white/20">
              <div className="flex items-center space-x-3 mb-6">
                <div className="w-2 h-8 bg-gradient-to-b from-green-600 to-green-400 rounded-full"></div>
              ...
              <form onSubmit={editingAgent ? handleUpdate : handleCreate} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="input-field rounded-2xl border-gray-200 dark:border-white/20 bg-white dark:bg-white/5 text-gray-900 dark:text-white focus:border-green-500 focus:ring-green-500 transition-all duration-200 placeholder-gray-400 dark:placeholder-gray-500"
