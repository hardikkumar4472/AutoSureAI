...
const HotspotMap = ({ className }) => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center space-y-4 bg-gradient-to-br from-gray-900 to-black text-white">
        <Loader className="w-12 h-12 animate-spin text-primary-500" />
        <p className="text-gray-300 text-lg">Loading accident hotspots...</p>
        <p className="text-sm text-gray-400">Analyzing global accident data</p>
      </div>
    );
  }
    ...
    <div className={className || "min-h-screen py-8 px-4 bg-white/10 backdrop-blur-lg shadow-2xl text-white"}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="space-y-4 mb-8">
          {error && (
            <div className="p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-2xl flex items-start space-x-3 backdrop-blur-sm">
          ...
          {usingMockData && (
            <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-2xl backdrop-blur-sm">
        ...
        {}
        <div className="mt-8 card rounded-3xl p-6 border border-white/20 bg-white/10 backdrop-blur-xl shadow-xl">
          <h3 className="text-lg font-semibold text-white mb-4">Risk Level Legend</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center space-x-3 p-3 bg-red-500/10 rounded-2xl border border-red-500/20">
            ...
            <div className="flex items-center space-x-3 p-3 bg-orange-500/10 rounded-2xl border border-orange-500/20">
            ...
            <div className="flex items-center space-x-3 p-3 bg-green-500/10 rounded-2xl border border-green-500/20">
